    ...
    public partial class ChangeIdGuidToInt : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Sem Categoria" });
            ...
            migrationBuilder.CreateIndex(
                name: "idx_unique_categories_name",
                table: "Categories",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_users_geolocation",
                table: "Users",
                columns: new[] { "Address_Geolocation_Lat", "Address_Geolocation_Long" });
