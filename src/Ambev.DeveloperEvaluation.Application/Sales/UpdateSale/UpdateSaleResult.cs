...
/// <summary>
/// Represents the result of a successful sale updating.
/// </summary>
public class UpdateSaleResult
{
    ...
    /// </summary>
    public UpdateSaleResult(int saleId, string saleNumber, DateTime saleDate, int customerId, string customerName, Money totalValue, string branch, string status, List<SaleItemResult> items)
    {
        SaleId = saleId;
