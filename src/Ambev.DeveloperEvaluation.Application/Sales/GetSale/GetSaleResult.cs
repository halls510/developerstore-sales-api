...
public class GetSaleResult
{
    ...
    /// </summary>
    public GetSaleResult(int saleId, string saleNumber, DateTime saleDate, int customerId, string customerName, Money totalValue, string branch, string status, List<SaleItemResult> items)
    {
        SaleId = saleId;
